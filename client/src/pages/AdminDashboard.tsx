    ...
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="ministries" className="w-full">
          <TabsList className="grid w-full grid-cols-3 lg:grid-cols-6 bg-gray-900/70 backdrop-blur-sm border border-gray-700/50 rounded-xl p-4 gap-2 shadow-lg shadow-black/20 min-h-[80px] items-center">

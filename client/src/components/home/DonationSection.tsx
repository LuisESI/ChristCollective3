      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
          ...
          <div className="bg-gray-50 rounded-xl p-8">
            <h3 className="text-2xl font-semibold mb-6">Start Your Own Campaign</h3>
            ...
            <form onSubmit={handleCreateCampaign} className="space-y-6">
              ...
              <div>
                <label htmlFor="description" className="block text-gray-700 font-medium mb-2">Campaign Description</label>
                <Textarea
                  id="description"
                  name="description"

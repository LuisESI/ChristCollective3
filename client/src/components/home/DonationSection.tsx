        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
          ...
          <div className="bg-gray-50 rounded-xl p-8">
            ...
            <form onSubmit={handleCreateCampaign} className="space-y-6">
              ...
              <div>
                <label htmlFor="description" className="block text-black font-medium mb-2">Campaign Description</label>
                <Textarea
                  id="description"
                  name="description"
              ...
              <div>
                <label className="block text-black font-medium mb-2">Campaign Image</label>
